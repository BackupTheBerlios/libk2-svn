...
namespace k2
{
	...
	struct is_primitive
	{
		static const bool	value =
			is_integer<type_>::value ?
			true : is_pointer<type_>::value ?
			true : false;
	};
	template <>
	...
	template <typename target_t_, typename source_t_>
	struct is_convertible
	{
		static const bool	value =
			static_cast<const target_t_*>(reinterpret_cast<const source_t_*>(&type_manip_private::conv_helper::dummy)) ?
			true : false;
	};
